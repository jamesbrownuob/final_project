...
function(CheckGitVersion)
    # Check if repository has been changed since the latest commit
    execute_process(
    ...
    if(NOT GIT_STATUS) #git status returns 0 there are no changes
    ...
    if(GIT_STATUS) #git status returns 0 there are no changes
        set(GIT_HASH "M")
    endif()
    ...
    if (NOT EXISTS ${post_configure_dir}/git_version.hh)
        file(COPY ${pre_configure_dir}/git_version.hh DESTINATION ${post_configure_dir})
    endif()

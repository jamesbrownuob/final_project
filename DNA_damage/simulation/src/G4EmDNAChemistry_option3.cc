...
{    
    G4cout << "Using new chem list" << G4endl;
...
void G4EmDNAChemistry_option3::ConstructMolecule()
{
  ...
  G4MoleculeTable::Instance()->GetConfiguration("Deoxyribose")->SetDiffusionCoefficient(
                          0 * (m2/s));

  G4MoleculeTable::Instance()->
  CreateConfiguration("Cytosine",G4Cytosine::Definition());
  G4MoleculeTable::Instance()->GetConfiguration("Cytosine")->SetDiffusionCoefficient(
                          0 * (m2/s));

  G4MoleculeTable::Instance()->
  CreateConfiguration("Thymine",G4Thymine::Definition());
  G4MoleculeTable::Instance()->GetConfiguration("Thymine")->SetDiffusionCoefficient(
                          0 * (m2/s));

  G4MoleculeTable::Instance()->
  CreateConfiguration("Guanine",G4Guanine::Definition());
  G4MoleculeTable::Instance()->GetConfiguration("Guanine")->SetDiffusionCoefficient(
                          0 * (m2/s));

  G4MoleculeTable::Instance()->
  CreateConfiguration("Adenine",G4Adenine::Definition());
  G4MoleculeTable::Instance()->GetConfiguration("Adenine")->SetDiffusionCoefficient(
                          0 * (m2/s));
                                              ...
                                              theReactionTable)
{
  ...
  // OH and DNA
    ...
    // OH
    reactionData = new G4DNAMolecularReactionData(
    1.80e9*(1e-3*m3/(mole*s)), OH, deoxyribose);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    6.1e9*(1e-3*m3/(mole*s)), OH, cytosine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    9.2e9*(1e-3*m3/(mole*s)), OH, guanine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    6.4e9*(1e-3*m3/(mole*s)), OH, thymine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    6.1e9*(1e-3*m3/(mole*s)), OH, adenine);
    theReactionTable->SetReaction(reactionData);

    // e-
    reactionData = new G4DNAMolecularReactionData(
    1.00e7*(1e-3*m3/(mole*s)), e_aq, deoxyribose);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    1.3e10*(1e-3*m3/(mole*s)), e_aq, cytosine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    9e9*(1e-3*m3/(mole*s)), e_aq, adenine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    1.8e10*(1e-3*m3/(mole*s)), e_aq, thymine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    1.4e10*(1e-3*m3/(mole*s)), e_aq, guanine);
    theReactionTable->SetReaction(reactionData);

    //H*
    reactionData = new G4DNAMolecularReactionData(
    2.9e7*(1e-3*m3/(mole*s)), H, deoxyribose);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    9.2e7*(1e-3*m3/(mole*s)), H, cytosine);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    5.7e8*(1e-3*m3/(mole*s)), H, thymine);
    theReactionTable->SetReaction(reactionData);


    reactionData = new G4DNAMolecularReactionData(
    1.0e8*(1e-3*m3/(mole*s)), H, adenine);
    theReactionTable->SetReaction(reactionData);

...
histoneFile = "../../../../geometryFiles/histonePositions_4x4_300nm.bin"
sugarFile = "../../../../geometryFiles/sugarPos_4x4_300nm.bin"
timePhoton = "0-01:00"
memPhoton = 1
targetSize = 300 #nanometers
gpsRadius = 5 #millimeters
...
for seed in seeds:
    ...
    with open(filename , 'w') as f:
        ...
        if slurm:
            ...
            f.write(f"#SBATCH --account=IFAC023282\n")
        ...
        f.write(f"time ../../../../simulation/build/rbe -mac secondary.in -photonPS photon_{seed}.bin -out secondary_{seed} -sugar {sugarFile} -histone {histoneFile} -seed {seed}\n")
        ...
        f.write(f"python ../../../../Clustering/run.py --filename secondary_{seed}.root --output photon_{seed}.csv --sugar {sugarFile} --filenamePhoton photon_{seed}.root  --continuous {continuous} --simulationType photon\n")
